...
(let    ((halcyon-black        "#4b5050")
  ...
  (custom-theme-set-faces
   ...
   `(outline-1 ((t (:inherit variable-pitch :foreground ,halcyon-dark-black :weight bold :height 1.4))))
   `(outline-2 ((t (:inherit variable-pitch :foreground ,halcyon-dark-black :weight normal :height 1.1))))
   `(outline-3 ((t (:inherit variable-pitch :foreground ,halcyon-dark-black :weight normal :height 1.1))))
   `(outline-4 ((t (:inherit variable-pitch :foreground ,halcyon-black :weight normal :height 1.1))))
   `(outline-5 ((t (:inherit variable-pitch :foreground ,halcyon-black :weight normal :height 1.1))))
   `(outline-6 ((t (:inherit variable-pitch :foreground ,halcyon-dark-gray :weight normal :height 1.1))))
   `(outline-7 ((t (:inherit variable-pitch :foreground ,halcyon-dark-gray :weight normal :height 1.1))))
   `(org-link ((t (:inherit variable-pitch :foreground ,halcyon-dark-blue))))
   `(org-date ((t (:foreground ,halcyon-green))))
   `(org-agenda-date ((t (:inherit variable-pitch :foreground ,halcyon-dark-gray :slant italic))))
   `(org-agenda-date-today ((t (:inherit variable-pitch :foreground ,halcyon-black :weight normal :height 1.5))))
